...
\thesistitle{A Relational Temporal Database Using Blockchain With Optimal
Snapshots} % Your thesis title, this is used in the title and abstract, print it elsewhere with \ttitle
...
\author{Amin \textsc{Beirami}} % Your name, this is used in the title page and abstract, print it elsewhere with \authorname
...
{\large August, 2018}\\ % Date
    ...
    {\large Copyright \textcopyright \hspace{0.3cm} Amin Beirami, 2018}
...
\include{src/ch1:motivation-problem-def}
\include{src/ch2:background-related-work}
\include{src/ch3:algorithms}
\include{src/ch4:experimental}
\include{src/ch5:conclusion}
